...
class PersonaSerializer(serializers.Serializer):
    ...
    activo = serializers.BooleanField(required=False) #no esta en el modelo -> default = True/False
...
class ReunionSerializer2(serializers.ModelSerializer):
    fecha_hora = serializers.SerializerMethodField() #valor nuevo a partir de otros valores
    class Meta:
        model = Reunion
        fields = (
            'id',
